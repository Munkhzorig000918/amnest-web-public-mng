        ...
        <div className="w-full bg-[#2D2D2D] text-white py-8 px-4 overflow-hidden flex flex-col items-start gap-y-6">
            <div className="flex items-start gap-x-3">
                <div className="flex items-start gap-x-2">
                    <Link href="#" className="text-white text-sm transition-colors font-bold" style={{ writingMode: "vertical-lr", textOrientation: "upright" }}>
                        ᠬᠣᠯᠪᠣᠭᠳᠠᠬᠤ ᠤᠲᠠᠰᠤ
                    </Link>
                    {new Array(8).fill(0).map((_, index) => (
                        <Link key={index} href="#" className="text-[#9B9B9B] text-sm transition-colors font-bold" style={{ writingMode: "vertical-lr", textOrientation: "upright" }}>
                            ᠬᠣᠯᠪᠣᠭᠳᠠᠬᠤ ᠤᠲᠠᠰᠤ
                        </Link>
                    ))}
                </div>
