  ...
  const renderCalendarDays = () => {
    ...
    for (let i = firstDay - 1; i >= 0; i--) {
      ...
      days.push(
        <div
          key={`prev-${day}`}
          className="border border-gray-200 p-2 text-gray-400 text-[8px] cursor-pointer hover:bg-gray-50 flex flex-col h-full min-h-[40px] w-full min-w-[40px]"
        >
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <div
          key={day}
          className={`border border-gray-200 p-2 text-[8px] cursor-pointer hover:bg-gray-50 relative flex flex-col h-full min-h-[40px] w-full min-w-[40px] ${
          ...
          <div className="grid grid-cols-7 bg-gray-50">
            {daysOfWeek.map((day) => (
              <div
                ...
                className="p-2 flex items-center justify-center text-[10px] font-medium text-gray-700 border-r border-gray-200 last:border-r-0"
              >
                {day}
              </div>
            ))}
