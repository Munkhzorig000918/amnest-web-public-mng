          ...
          <div className="h-full flex gap-10">
            ...
            <div className="h-full grid grid-cols-1 grid-rows-3 gap-5">
              {[1, 2, 3].map((item) => (
                <div
                  key={item}
                  className="w-full h-full flex items-start space-x-4"
                >
                  <h3
                  ...
                  >
                    ...
                    ᠮᠠᠨ ᠤ᠋ ᠮᠡᠷᢉᠡᠵᠢᠯᠲᠡᠨ ᠨᠦ᠋ᢉᠦᠳ ᠳᠡᠯᠡᢈᠡᠢ ᠶ᠋ᠢᠨ ᢈᠡᠮᠵᠢᠶᠡᠨ ᠳ᠋ᠦ ᠵᠠᠰᠠᠭ
                    ᠤ᠋ᠨ ᠭᠠᠵᠠᠷ ᠪᠣᠯᠤᠨ ᠪᠤᠰᠤᠳ ᢈᠦᠮᠦᠰ ᠋ᠨ ᢈᠦᠮᠦᠨ ᠦ᠋ ᠡᠷᢈᠡ ᠶ᠋ᠢᠨ ᠵᠥᠷᠢᠴᠡᠯ
                    ᠦ᠋ᠨ ᠲᠠᠯᠠᠭᠠᠷ ᠦᠨᠡᠨ ᠵᠥᠪ᠂ ᢈᠥᠨᠳᠡᠯᠡᠨ ᠰᠢᠯᠭᠠᠭᠰᠠᠨ ᠰᠤᠳᠤᠯᠭ᠎ᠠ ᢈᠢᠳᠡᢉ᠃
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="h-full flex gap-10">
            ...
            <div className="h-full grid grid-cols-5 grid-rows-3 gap-[10px]">
              {workItems.map((item) => (
                <div
                  key={item.id}
                  className="w-40 h-full flex flex-col items-center justify-center gap-5 border border-black p-4"
                >
